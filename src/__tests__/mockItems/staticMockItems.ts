import type { User, WorkOrder, Invoice, Contact } from "@types";
...
/**
 * Mock `Contact` objects, organized by name.
 */
  ...
  myWorkOrders: {
    createdByUser: [
      ...
      },
      {
        ...
        status: "ASSIGNED",
        priority: "HIGH",
        createdAt: new Date("2022-10-01T03:24:00"),
        updatedAt: new Date()
      }
    ],
    assignedToUser: [
  ...
  myInvoices: {
    ...
    assignedToUser: [
      ...
      },
      {
        ...
        createdBy: MOCK_CONTACTS.Randy_LeDude,
        assignedTo: MOCK_USERS.Guy_McPerson,
        createdAt: new Date("2022-09-01T03:24:00"),
        updatedAt: new Date()
      }
    ]
  }
