...
// ["SCREEN", "LINEAR_LIGHT"].reduce((hexCode, label, index) => {
//   return Object.assign(hexCode, { [label]: index });
// }, {});
...
//               );
//             } else {
//               this.debug("Material.attachUniforms", {
//                 name: name,
//                 uniform: uniforms
//               });
...
//   el: undefined; // FIXME what does this.el get set to
//   cssVarRetries: number;
//   maxCssVarRetries: number;
//   angle: number;
//   isLoadedClass: boolean;
//   isScrolling: boolean;
//   // source author property "isStatic" was commented out, but property type looks like below
//   isStatic: boolean;
//   scrollingTimeout: undefined; // FIXME what does this.scrollingTimeout get set to
...
//   vertexShader: undefined; // FIXME
//   sectionColors: undefined; // FIXME
//   computedCanvasStyle: undefined; // FIXME
...
//   xSegCount: number;
//   ySegCount: number;
//   mesh: undefined; // FIXME
//   material: undefined; // FIXME
//   geometry: undefined; // FIXME
//   minigl: undefined; // FIXME
//   scrollObserver: undefined; // FIXME
//   amp: number;
//   seed: number;
//   freqX: number;
//   freqY: number;
...
//   handleScroll: (...args: any[]) => any; // TODO better type
//   handleScrollEnd: (...args: any[]) => any; // TODO better type
//   resize: (...args: any[]) => any; // TODO better type
//   handleMouseDown: (...args: any[]) => any; // TODO better type
//   handleKeyDown: (...args: any[]) => any; // TODO better type
//   handleMouseUp: (...args: any[]) => any; // TODO better type
//   animate: (...args: any[]) => any; // TODO better type
//   addIsLoadedClass: (...args: any[]) => any; // TODO better type
//   pause: (...args: any[]) => any; // TODO better type
//   play: (...args: any[]) => any; // TODO better type
//   initGradient: (...args: any[]) => any; // TODO better type
...
//       if (this.conf?.playing && !this.isScrolling) this.pause();
//     };
